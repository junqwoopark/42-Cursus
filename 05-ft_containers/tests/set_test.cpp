...
int main() {
  ...
  // insert()
  {
    ...
    std::pair<NAMESPACE::set<int>::iterator, bool> ret;
  ...
  // swap()
  {
    ...
    for (NAMESPACE::set<int>::iterator it = first.begin(); it != first.end(); ++it) std::cout << ' ' << *it;
    std::cout << '\n';

    std::cout << "second contains:";
    for (NAMESPACE::set<int>::iterator it = second.begin(); it != second.end(); ++it) std::cout << ' ' << *it;
    std::cout << '\n';
  }
  ...
  // equal_range()
  {
    ...
    std::pair<NAMESPACE::set<int>::const_iterator, NAMESPACE::set<int>::const_iterator> ret;
